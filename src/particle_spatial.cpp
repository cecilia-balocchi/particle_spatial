...
int main(){
  ...
  //mat Y, X, A_block;
  Y.load("data/Y_jan10.csv", csv_ascii);
  X.load("data/X_jan10.csv", csv_ascii);
  A_block.load("data/A_block_jan10.csv", csv_ascii);
